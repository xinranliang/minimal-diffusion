...
def main():
    ...
    parser.add_argument("ref_batch", default=None, help="path to real reference batch npz file")
    parser.add_argument("sample_batch", help="path to fake sample batch npz file")
