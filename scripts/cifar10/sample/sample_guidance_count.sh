...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-03-19/cifar10_guidance_fixtotal_cond_dropprob0.1_count.txt            # where stdout and stderr will write to
