...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-02-02/cifar10_sample_guidance_color1.0_gray0.0_puncond_0.2.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port 8106 main.py \
    ...
    --ckpt-name cifar10_cond_color1.0_gray0.0_puncond0.2_epoch1k_ema \
    --pretrained-ckpt ./logs/2023-02-02/cifar10/color1.0_gray0.0/UNet_diffusionstep_1000_samplestep_250_condition_True_lr_0.0001_bs_256_dropprob_0.2/ckpt/epoch_final_ema_0.9995.pth
