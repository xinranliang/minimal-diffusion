...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-02-02/cifar10_train_color1.0_gray0.0_cond_drop_prob_0.1.txt            # where stdout and stderr will write to
