...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-01/fixed_latent_viz.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python fixed_latent.py \
