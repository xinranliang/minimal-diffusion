...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-07-31/eval_domain_check_cifar_imagenet_cond_droprob0.1.txt            # where stdout and stderr will write to
