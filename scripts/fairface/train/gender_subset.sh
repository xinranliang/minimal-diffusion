...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-07-26/fairface_train_cond_droprob0.1_gendersubset_female0.5_male0.5.txt            # where stdout and stderr will write to
