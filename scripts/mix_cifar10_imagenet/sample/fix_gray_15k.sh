...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    ...
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 0 --fix gray \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    ...
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 7500 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 15000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 22500 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 30000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 60000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 90000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 120000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 150000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 180000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 210000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-02 --grayscale 15000 --color 240000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 0 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color0_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 7500 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color7.5_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 15000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color15_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 22500 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color22.5_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 30000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color30_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 60000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color60_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 90000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color90_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 120000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color120_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 150000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color150_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 180000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color180_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 210000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color210_ema \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=8 --master_port 8103 main.py \
    --arch UNet --dataset mix-cifar10-imagenet --batch-size 5000 --num-sampled-images 15000 --sampling-gray-only --sampling-steps 250 \
    --data-dir ./datasets --save-dir ./logs/ --date 2023-04-03 --grayscale 15000 --color 240000 --fix gray \
    --class-cond --classifier-free-w 0.0 --class-cond-dropout 0.1 \
    --ckpt-name mix_cifar10_imagenet_cond_gray15_color240_ema \
