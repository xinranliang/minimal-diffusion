...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-02/mix_cifar10_imagenet_train_cond_color15_gray240_droprob0.1.txt            # where stdout and stderr will write to
