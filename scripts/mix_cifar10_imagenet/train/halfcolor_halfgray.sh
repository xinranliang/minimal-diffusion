...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-02/mix_cifar10_imagenet_train_cond_half_gray120k_droprob0.1.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port $3 main.py \
    ...
    --save-dir ./logs/ --date 2023-04-02 \
    --color 0 --grayscale $1 --fix half
