...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-09/mnist_train_cond_droprob0.1_flipsub_left0.9_right0.1.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0 python main.py \
    --arch UNetSmall --dataset mnist-subset --epochs 100 --batch-size 256 --lr 1e-4 --sampling-steps 250 \
    --data-dir ./datasets --diffusion-steps 1000 --ema_w 0.9995 --ckpt-sample-freq 20 \
