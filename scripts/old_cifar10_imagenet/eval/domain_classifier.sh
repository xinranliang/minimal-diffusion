...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-08/cifar10_imagenet_domain_classifier_eval_gan.txt            # where stdout and stderr will write to
...
for lr in 0.01 0.005 0.001 0.0005 0.0001; do 
    for wd in 0.001 0.0001 0.00001; do 
        ...
        --arch resnet50 --dataset cifar10-imagenet --num-domains 2 --mode test-gan \
