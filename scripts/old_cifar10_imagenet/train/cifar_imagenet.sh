...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-07/cifar50k_imagenet200k_train_cond_droprob0.1.txt            # where stdout and stderr will write to
