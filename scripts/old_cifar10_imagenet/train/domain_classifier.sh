...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-04-08/cifar10_imagenet_domain_classifier.txt            # where stdout and stderr will write to
