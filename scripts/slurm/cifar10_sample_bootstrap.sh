...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-01-14/cifar10_color0.95_gray0.05_sample_bootstrap.txt            # where stdout and stderr will write to
