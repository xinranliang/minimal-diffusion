...
#SBATCH --output=/n/fs/xl-diffbia/projects/minimal-diffusion/slurm_output/2023-02-21/cifar10_train_color25_gray20_cond_droprob0.1.txt            # where stdout and stderr will write to
...
CUDA_VISIBLE_DEVICES=0,1 python -m torch.distributed.launch --nproc_per_node=2 --master_port $3 main.py \
    ...
    --save-dir ./logs/ --date 2023-02-21 \
    --color 25000 --grayscale $1 --fix subgroup
