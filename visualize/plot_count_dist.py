...
def plot_guidance_dist(color_count, gray_count, color_split, gray_split, num_samples = 50000):
    ...
    with plt.style.context('ggplot'):
        plt.plot(ws, np.array(color_count, dtype=np.float64) / num_samples, linestyle="-", linewidth=1, color="black", marker="o", markersize=5, markeredgecolor="blue", markerfacecolor="blue", label="Percentage in generated samples")
        ...
        plt.legend()
    plt.savefig(os.path.join("/n/fs/xl-diffbia/projects/minimal-diffusion/logs/2023-02-06/cifar10/figures", "guidance_count_color{}_gray{}.png".format(color_split, gray_split)), dpi=300, bbox_inches="tight")
    plt.savefig(os.path.join("/n/fs/xl-diffbia/projects/minimal-diffusion/logs/2023-02-06/cifar10/figures", "guidance_count_color{}_gray{}.pdf".format(color_split, gray_split)), dpi=300, bbox_inches="tight")
    plt.close()
